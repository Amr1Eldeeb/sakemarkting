...
export class ContactComponent {
  ...
  contactInfo = [
    { icon: 'bi-geo-alt-fill', color: '#6c63ff', label: 'Address', value: '123 Digital Hub, 6 October, Giza , Egypt' },
    { icon: 'bi-telephone-fill', color: '#00d4ff', label: 'Phone', value: '+201115332546' },
    { icon: 'bi-envelope-fill', color: '#ff6b9d', label: 'Email', value: 'Info@Sake-Marketing.com' },
    { icon: 'bi-clock-fill', color: '#ffd700', label: 'Working Hours', value: 'Sunday - Thursday: 9:00 AM - 6:00 PM' }
  ];
